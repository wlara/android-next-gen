package com.github.wlara.nextgen.comment.ui.landing
...
@Composable
fun CommentLandingScreen(
    onShowCommentDetails: (Int) -> Unit,
    onShowRawData: () ->Unit,
    viewModel: CommentLandingViewModel = hiltViewModel()
) {
            ...
            LazyColumn(
                ...
                item {
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.header_comments),
